...
From the original SfePy source code: sfepy/postprocess/probes_vtk.py
updated on Wed Mar 14 2018 by Jaywan Chung: use our own 'get_vtk_from_mesh' function;
    the function does not use a temporary directory anymore.
"""
...
from pykeri.sfepy_util.utils_vtk import get_vtk_from_mesh, get_vtk_from_file
